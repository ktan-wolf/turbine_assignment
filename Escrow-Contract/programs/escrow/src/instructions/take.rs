...
pub struct Take<'info> {
    ...
    pub taker_account_a : Box<InterfaceAccount<'info , TokenAccount>>,
    ...
    pub taker_account_b :InterfaceAccount<'info , TokenAccount>,
    ...
    pub maker_account_b : Box<InterfaceAccount<'info , TokenAccount>>,
...
impl <'info> Take<'info> {
    pub fn transfer_to_maker(&mut self) -> Result<()> {
        let transfer_account = TransferChecked {
            from: self.taker_account_b.to_account_info(),
            mint: self.mint_b.to_account_info(),
            to: self.maker_account_b.to_account_info(),
    ...
    pub fn withdraw_and_close_vault(&mut self) -> Result<()> {
        let transfer_accounts = TransferChecked {
            ...
            to: self.taker_account_a.to_account_info(),
